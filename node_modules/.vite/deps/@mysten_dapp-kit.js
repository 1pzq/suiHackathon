import {
  ...
  useQueries,
  useQuery
} from "./chunk-ARYWBKK4.js";
import {
  SuiClient,
  getFullnodeUrl,
  isSuiClient
} from "./chunk-NSIABQ7X.js";
import {
  Hash,
  Transaction,
  blake2b,
...
import {
  ...
  toB64,
  toHEX
} from "./chunk-P4ZALDMY.js";
import "./chunk-OZ6DKMRD.js";
import {
  require_react
  ...
  "node_modules/.pnpm/tweetnacl@1.0.3/node_modules/tweetnacl/nacl-fast.js"(exports, module) {
    (function(nacl4) {
      ...
      function crypto_sign(sm, m, n2, sk) {
        var d2 = new Uint8Array(64), h = new Uint8Array(64), r2 = new Uint8Array(64);
...
// node_modules/.pnpm/@mysten+dapp-kit@0.14.15_@tanstack+react-query@5.51.23_@types+react-dom@18.3.0_@types+react@1_vx4wchazbr6sn45vhxtzr23ysq/node_modules/@mysten/dapp-kit/dist/esm/index.js
var import_react2 = __toESM(require_react());
var import_react3 = __toESM(require_react());

// node_modules/.pnpm/zustand@4.5.4_@types+react@18.3.3_react@18.3.1/node_modules/zustand/esm/vanilla.mjs
...
// node_modules/.pnpm/zustand@4.5.4_@types+react@18.3.3_react@18.3.1/node_modules/zustand/esm/index.mjs
...
// node_modules/.pnpm/@mysten+wallet-standard@0.13.0_typescript@5.5.4/node_modules/@mysten/wallet-standard/dist/esm/wallet.js
...
// node_modules/.pnpm/@mysten+wallet-standard@0.13.0_typescript@5.5.4/node_modules/@mysten/wallet-standard/dist/esm/detect.js
...
// node_modules/.pnpm/@mysten+wallet-standard@0.13.0_typescript@5.5.4/node_modules/@mysten/wallet-standard/dist/esm/chains.js
...
// node_modules/.pnpm/@vanilla-extract+recipes@0.5.3_@vanilla-extract+css@1.15.3/node_modules/@vanilla-extract/recipes/dist/createRuntimeFn-62c9670f.esm.js
...
// node_modules/.pnpm/@mysten+sui@1.5.0_typescript@5.5.4/node_modules/@mysten/sui/dist/esm/cryptography/intent.js
...
// node_modules/.pnpm/@mysten+sui@1.5.0_typescript@5.5.4/node_modules/@mysten/sui/dist/esm/cryptography/publickey.js
...
// node_modules/.pnpm/@mysten+sui@1.5.0_typescript@5.5.4/node_modules/@mysten/sui/dist/esm/cryptography/signature-scheme.js
...
// node_modules/.pnpm/@mysten+sui@1.5.0_typescript@5.5.4/node_modules/@mysten/sui/dist/esm/graphql/client.js
var __typeError = (msg) => {
  throw TypeError(msg);
};
...
var GraphQLError2 = class extends Error {
  constructor(e3, r2, i2, n2, a2, t2, l2) {
    super(e3);
    this.name = "GraphQLError";
    this.message = e3;
    if (a2) {
...
// node_modules/.pnpm/gql.tada@1.8.5_graphql@16.9.0_typescript@5.5.4/node_modules/gql.tada/dist/gql-tada.mjs
function initGraphQLTada() {
  ...
  graphql3.scalar = function scalar(n2, r2) {
    return r2;
  };
  graphql3.persisted = function persisted(r2, e3) {
    return {
      kind: e.DOCUMENT,
...
// node_modules/.pnpm/@mysten+sui@1.5.0_typescript@5.5.4/node_modules/@mysten/sui/dist/esm/graphql/schemas/2024.4/index.js
var graphql2 = initGraphQLTada();

// node_modules/.pnpm/@mysten+sui@1.5.0_typescript@5.5.4/node_modules/@mysten/sui/dist/esm/zklogin/jwt-utils.js
...
// node_modules/.pnpm/@mysten+sui@1.5.0_typescript@5.5.4/node_modules/@mysten/sui/dist/esm/zklogin/bcs.js
...
// node_modules/.pnpm/@mysten+sui@1.5.0_typescript@5.5.4/node_modules/@mysten/sui/dist/esm/zklogin/signature.js
...
// node_modules/.pnpm/@mysten+sui@1.5.0_typescript@5.5.4/node_modules/@mysten/sui/dist/esm/zklogin/utils.js
function toPaddedBigEndianBytes(num, width) {
  const hex2 = num.toString(16);
  return hexToBytes(hex2.padStart(width * 2, "0").slice(-width * 2));
}

// node_modules/.pnpm/@mysten+sui@1.5.0_typescript@5.5.4/node_modules/@mysten/sui/dist/esm/zklogin/publickey.js
...
var _ZkLoginPublicIdentifier = class _ZkLoginPublicIdentifier2 extends PublicKey {
  ...
  constructor(value2, { client } = {}) {
    ...
    if (typeof value2 === "string") {
      __privateSet2(this, _data, fromB64(value2));
...
function parseSerializedZkLoginSignature(signature) {
  const bytes2 = typeof signature === "string" ? fromB64(signature) : signature;
  ...
  return {
    serializedSignature: toB64(bytes2),
...
// node_modules/.pnpm/@mysten+sui@1.5.0_typescript@5.5.4/node_modules/@mysten/sui/dist/esm/cryptography/signature.js
...
var hex = chain(radix2(4), alphabet("0123456789abcdef"), join2(""), normalize((s2) => {
...
// node_modules/.pnpm/@mysten+sui@1.5.0_typescript@5.5.4/node_modules/@mysten/sui/dist/esm/cryptography/mnemonics.js
...
// node_modules/.pnpm/@mysten+sui@1.5.0_typescript@5.5.4/node_modules/@mysten/sui/dist/esm/cryptography/keypair.js
...
// node_modules/.pnpm/@mysten+sui@1.5.0_typescript@5.5.4/node_modules/@mysten/sui/dist/esm/keypairs/ed25519/keypair.js
var import_tweetnacl3 = __toESM(require_nacl_fast(), 1);

// node_modules/.pnpm/@mysten+sui@1.5.0_typescript@5.5.4/node_modules/@mysten/sui/dist/esm/keypairs/ed25519/ed25519-hd-key.js
...
// node_modules/.pnpm/@mysten+sui@1.5.0_typescript@5.5.4/node_modules/@mysten/sui/dist/esm/keypairs/ed25519/publickey.js
...
// node_modules/.pnpm/@mysten+zksend@0.10.4_typescript@5.5.4/node_modules/@mysten/zksend/dist/esm/links/zk-bag.js
var _package;
var _module;
_package = /* @__PURE__ */ new WeakMap();
_module = /* @__PURE__ */ new WeakMap();

// node_modules/.pnpm/@mysten+zksend@0.10.4_typescript@5.5.4/node_modules/@mysten/zksend/dist/esm/links/builder.js
...
objectsToTransfer_fn = async function(tx) {
  ...
  const refsWithType = this.objectRefs.concat(
    (objectIDs.length > 0 ? await __privateGet3(this, _client2).multiGetObjects({
      ids: objectIDs,
      options: {
        showType: true
      }
...
estimateClaimGasFee_fn = async function() {
  ...
  const result = await __privateGet3(this, _client2).dryRunTransactionBlock({
    transactionBlock: await tx.build({ client: __privateGet3(this, _client2) })
  });
...
getCoinsByType_fn = async function(coinType) {
  if (__privateGet3(this, _coinsByType).has(coinType)) {
    return __privateGet3(this, _coinsByType).get(coinType);
  }
  const coins = await __privateGet3(this, _client2).getCoins({
    coinType,
    owner: this.sender
  });
  __privateGet3(this, _coinsByType).set(coinType, coins.data);
  return coins.data;
};

// node_modules/.pnpm/@mysten+zksend@0.10.4_typescript@5.5.4/node_modules/@mysten/zksend/dist/esm/links/utils.js
function getAssetsFromTransaction({
  ...
  const nfts = [];
  const coins = [];
  (_a = transaction.balanceChanges) == null ? void 0 : _a.forEach((change) => {
  ...
  (_b = transaction.objectChanges) == null ? void 0 : _b.forEach((change) => {
...
// node_modules/.pnpm/@mysten+zksend@0.10.4_typescript@5.5.4/node_modules/@mysten/zksend/dist/esm/links/claim.js
...
var __privateSet3 = (obj, member, value2, setter) => (__accessCheck4(obj, member, "write to private field"), setter ? setter.call(obj, value2) : member.set(obj, value2), value2);
...
loadBagObject_fn = async function() {
  if (!__privateGet4(this, _contract2)) {
    throw new Error("Cannot load bag object for non-contract based links");
  }
  const bagField = await __privateGet4(this, _client3).getDynamicFieldObject({
    parentId: __privateGet4(this, _contract2).ids.bagStoreTableId,
    name: {
      type: "address",
      value: this.address
    }
...
loadBag_fn = async function({
  ...
  if (!this.bagObject || !this.claimed) {
    await __privateMethod2(this, _ZkSendLink_instances, loadBagObject_fn).call(this);
  }
  if (!loadAssets) {
    return;
  }
  if (!this.bagObject) {
    if (loadClaimedAssets) {
      await __privateMethod2(this, _ZkSendLink_instances, loadClaimedAssets_fn).call(this);
    }
    return;
  }
  const bagId = (_b = (_a = this.bagObject.content.fields.value.fields) == null ? void 0 : _a.id) == null ? void 0 : _b.id;
  ...
  const objectsResponse = await __privateGet4(this, _client3).multiGetObjects({
    ids: itemIds,
    options: {
      showType: true,
      showContent: true
  ...
  objectsResponse.forEach((object2, i2) => {
    var _a2;
    ...
    if (type2.address === normalizeSuiAddress("0x2") && type2.module === "coin" && type2.name === "Coin") {
      ...
      if (((_a2 = object2.data.content) == null ? void 0 : _a2.dataType) === "moveObject") {
...
loadClaimedAssets_fn = async function() {
  var _a;
  const result = await __privateGet4(this, _client3).queryTransactionBlocks({
    limit: 1,
    filter: {
  ...
  if (((_a = tx.transaction) == null ? void 0 : _a.data.transaction.kind) !== "ProgrammableTransaction") {
    return;
  }
...
createSponsoredTransaction_fn = async function(tx, claimer, sender) {
  return __privateMethod2(this, _ZkSendLink_instances, fetch_fn).call(this, "transaction-blocks/sponsor", {
    method: "POST",
    body: JSON.stringify({
      network: __privateGet4(this, _network),
      sender,
      claimer,
      transactionBlockKindBytes: toB64(
        await tx.build({
          onlyTransactionKind: true,
          client: __privateGet4(this, _client3)
        })
      )
    })
  });
...
executeSponsoredTransaction_fn = async function(input, signature) {
  return __privateMethod2(this, _ZkSendLink_instances, fetch_fn).call(this, `transaction-blocks/sponsor/${input.digest}`, {
    method: "POST",
    body: JSON.stringify({
      signature
    })
...
fetch_fn = async function(path, init) {
  const res = await fetch(`${__privateGet4(this, _claimApi)}/v1/${path}`, {
    ...init,
    headers: {
      ...init.headers,
      "Content-Type": "application/json"
...
listNonContractClaimableAssets_fn = async function() {
  ...
  const nfts = [];
  const coins = [];
  if (__privateGet4(this, _ownedObjects).length === 0 && !__privateGet4(this, _hasSui)) {
    return {
      balances,
      nfts,
      coins
  ...
  if (__privateGet4(this, _gasCoin) || !__privateGet4(this, _hasSui)) {
    tx.setGasPayment([]);
  }
  const dryRun = await __privateGet4(this, _client3).dryRunTransactionBlock({
    transactionBlock: await tx.build({ client: __privateGet4(this, _client3) })
  });
...
createNonContractClaimTransaction_fn = function(address) {
  ...
  const objectsToTransfer = __privateGet4(this, _ownedObjects).filter((object2) => {
    if (__privateGet4(this, _gasCoin)) {
      if (object2.objectId === __privateGet4(this, _gasCoin).coinObjectId) {
        return false;
      }
    ...
    return true;
  }).map((object2) => tx.object(object2.objectId));
  if (__privateGet4(this, _gasCoin) && this.creatorAddress) {
...
loadOwnedObjects_fn = async function({
  ...
  let nextCursor;
  do {
    const ownedObjects = await __privateGet4(this, _client3).getOwnedObjects({
      cursor: nextCursor,
      owner: this.address,
      options: {
        showType: true,
    ...
    for (const object2 of ownedObjects.data) {
      if (object2.data) {
        __privateGet4(this, _ownedObjects).push({
  ...
  const coins = await __privateGet4(this, _client3).getCoins({
    coinType: SUI_COIN_TYPE2,
    owner: this.address
  });
  __privateSet3(this, _hasSui, coins.data.length > 0);
  __privateSet3(this, _gasCoin, coins.data.find((coin) => BigInt(coin.balance) % 1000n === 987n));
  const result = await __privateGet4(this, _client3).queryTransactionBlocks({
    limit: 1,
    order: "ascending",
    filter: {
  ...
  if (__privateGet4(this, _hasSui) || __privateGet4(this, _ownedObjects).length > 0) {
    this.claimed = false;
    this.assets = await __privateMethod2(this, _ZkSendLink_instances, listNonContractClaimableAssets_fn).call(this);
...
// node_modules/.pnpm/@mysten+zksend@0.10.4_typescript@5.5.4/node_modules/@mysten/zksend/dist/esm/links/list-created-links.js
...
// node_modules/.pnpm/@mysten+zksend@0.10.4_typescript@5.5.4/node_modules/@mysten/zksend/dist/esm/utils/withResolvers.js
...
// node_modules/.pnpm/@mysten+zksend@0.10.4_typescript@5.5.4/node_modules/@mysten/zksend/dist/esm/wallet/channel/events.js
...
// node_modules/.pnpm/@mysten+zksend@0.10.4_typescript@5.5.4/node_modules/@mysten/zksend/dist/esm/wallet/channel/index.js
...
var __privateAdd3 = (obj, member, value2) => member.has(obj) ? __typeError5("Cannot add the same private member more than once") : member instanceof WeakSet ? member.add(obj) : member.set(obj, value2);
var __privateSet4 = (obj, member, value2, setter) => (__accessCheck5(obj, member, "write to private field"), setter ? setter.call(obj, value2) : member.set(obj, value2), value2);
...
var cleanup_fn;
var _request;
var DEFAULT_STASHED_ORIGIN = "https://getstashed.com";
var StashedPopup = class {
  constructor({ name, origin = DEFAULT_STASHED_ORIGIN }) {
    __privateAdd3(this, _StashedPopup_instances);
    __privateAdd3(this, _popup);
    __privateAdd3(this, _id);
    __privateAdd3(this, _origin);
    __privateAdd3(this, _name);
    __privateAdd3(this, _promise);
    __privateAdd3(this, _resolve);
    __privateAdd3(this, _reject);
    __privateAdd3(this, _interval, null);
    __privateAdd3(this, _listener, (event) => {
      if (event.origin !== __privateGet5(this, _origin)) {
        return;
      }
      const { success, output: output2 } = safeParse(StashedResponse, event.data);
      if (!success || output2.id !== __privateGet5(this, _id)) return;
      __privateMethod3(this, _StashedPopup_instances, cleanup_fn).call(this);
      if (output2.payload.type === "reject") {
        __privateGet5(this, _reject).call(this, new Error("User rejected the request"));
      } else if (output2.payload.type === "resolve") {
        __privateGet5(this, _resolve).call(this, output2.payload.data);
      }
    });
    ...
    __privateSet4(this, _popup, popup);
    __privateSet4(this, _id, crypto.randomUUID());
    __privateSet4(this, _origin, origin);
    __privateSet4(this, _name, name);
    const { promise, resolve, reject } = withResolvers();
    __privateSet4(this, _promise, promise);
    __privateSet4(this, _resolve, resolve);
    __privateSet4(this, _reject, reject);
    __privateSet4(this, _interval, setInterval(() => {
      try {
        if (__privateGet5(this, _popup).closed) {
          __privateMethod3(this, _StashedPopup_instances, cleanup_fn).call(this);
  ...
  send({
    ...
    window.addEventListener("message", __privateGet5(this, _listener));
    __privateGet5(this, _popup).location.assign(
      `${__privateGet5(this, _origin)}/dapp/${type2}?${new URLSearchParams({
        id: __privateGet5(this, _id),
        origin: window.origin,
        name: __privateGet5(this, _name)
      })}${data ? `#${new URLSearchParams(data)}` : ""}`
    );
    return __privateGet5(this, _promise);
  }
  close() {
    __privateMethod3(this, _StashedPopup_instances, cleanup_fn).call(this);
    __privateGet5(this, _popup).close();
  }
};
...
cleanup_fn = function() {
  if (__privateGet5(this, _interval)) {
    clearInterval(__privateGet5(this, _interval));
    __privateSet4(this, _interval, null);
  }
  window.removeEventListener("message", __privateGet5(this, _listener));
};
_request = /* @__PURE__ */ new WeakMap();

// node_modules/.pnpm/@mysten+zksend@0.10.4_typescript@5.5.4/node_modules/@mysten/zksend/dist/esm/wallet/index.js
...
var __privateAdd4 = (obj, member, value2) => member.has(obj) ? __typeError6("Cannot add the same private member more than once") : member instanceof WeakSet ? member.add(obj) : member.set(obj, value2);
var __privateSet5 = (obj, member, value2, setter) => (__accessCheck6(obj, member, "write to private field"), setter ? setter.call(obj, value2) : member.set(obj, value2), value2);
...
var STASHED_WALLET_NAME = "Stashed";
var StashedWallet = class {
  constructor({
    name,
    address,
    origin = DEFAULT_STASHED_ORIGIN
  }) {
    __privateAdd4(this, _StashedWallet_instances);
    __privateAdd4(this, _events);
    __privateAdd4(this, _accounts);
    __privateAdd4(this, _origin2);
    __privateAdd4(this, _name2);
    __privateAdd4(this, _signTransactionBlock, async ({ transactionBlock, account }) => {
      transactionBlock.setSenderIfNotSet(account.address);
      const data = transactionBlock.serialize();
      const popup = new StashedPopup({
        name: __privateGet6(this, _name2),
        origin: __privateGet6(this, _origin2)
      });
    ...
    __privateAdd4(this, _signTransaction, async ({ transaction, account }) => {
      const popup = new StashedPopup({
        name: __privateGet6(this, _name2),
        origin: __privateGet6(this, _origin2)
      });
    ...
    __privateAdd4(this, _signPersonalMessage, async ({ message, account }) => {
      const popup = new StashedPopup({
        name: __privateGet6(this, _name2),
        origin: __privateGet6(this, _origin2)
      });
      const bytes2 = toB64(message);
      const response = await popup.send({
    ...
    __privateAdd4(this, _on, (event, listener) => {
      __privateGet6(this, _events).on(event, listener);
      return () => __privateGet6(this, _events).off(event, listener);
    });
    __privateAdd4(this, _connect, async (input) => {
      if (input == null ? void 0 : input.silent) {
        const address2 = localStorage.getItem(STASHED_RECENT_ADDRESS_KEY);
        if (address2) {
          __privateMethod4(this, _StashedWallet_instances, setAccount_fn).call(this, address2);
        }
        return { accounts: this.accounts };
      }
      const popup = new StashedPopup({ name: __privateGet6(this, _name2), origin: __privateGet6(this, _origin2) });
      const response = await popup.send({
        type: "connect"
      });
      ...
      __privateMethod4(this, _StashedWallet_instances, setAccount_fn).call(this, response.address);
      return { accounts: this.accounts };
    });
    __privateAdd4(this, _disconnect, async () => {
      localStorage.removeItem(STASHED_RECENT_ADDRESS_KEY);
      __privateMethod4(this, _StashedWallet_instances, setAccount_fn).call(this);
    });
    __privateSet5(this, _accounts, []);
    __privateSet5(this, _events, mitt_default());
    __privateSet5(this, _origin2, origin);
    __privateSet5(this, _name2, name);
    if (address) {
      __privateMethod4(this, _StashedWallet_instances, setAccount_fn).call(this, address);
    }
  }
  get name() {
  ...
  get features() {
    return {
      ...
      "sui:signTransactionBlock": {
        version: "1.0.0",
        signTransactionBlock: __privateGet6(this, _signTransactionBlock)
      },
      "sui:signTransaction": {
        version: "2.0.0",
...
setAccount_fn = function(address) {
  ...
  __privateGet6(this, _events).emit("change", { accounts: this.accounts });
};
...
// node_modules/.pnpm/zustand@4.5.4_@types+react@18.3.3_react@18.3.1/node_modules/zustand/esm/middleware.mjs
...
// node_modules/.pnpm/@vanilla-extract+css@1.15.3/node_modules/@vanilla-extract/css/injectStyles/dist/vanilla-extract-css-injectStyles.browser.esm.js
var stylesheets = {};
...
// node_modules/.pnpm/@vanilla-extract+css@1.15.3/node_modules/@vanilla-extract/css/dist/transformCss-72a2e7e9.browser.esm.js
...
// node_modules/.pnpm/@vanilla-extract+css@1.15.3/node_modules/@vanilla-extract/css/adapter/dist/vanilla-extract-css-adapter.browser.esm.js
var mockAdapter = {
  appendCss: () => {
  },
  registerClassName: () => {
...
// node_modules/.pnpm/@vanilla-extract+css@1.15.3/node_modules/@vanilla-extract/css/dist/taggedTemplateLiteral-8e47dbd7.browser.esm.js
...
// node_modules/.pnpm/@vanilla-extract+css@1.15.3/node_modules/@vanilla-extract/css/dist/vanilla-extract-css.browser.esm.js
...
var __privateAdd5 = (obj, member, value2) => member.has(obj) ? __typeError7("Cannot add the same private member more than once") : member instanceof WeakSet ? member.add(obj) : member.set(obj, value2);
...
var StyleMarker = (0, import_react5.forwardRef)(({ children, ...props }, forwardedRef) => (0, import_jsx_runtime3.jsx)(Slot, { ref: forwardedRef, ...props, ...styleDataAttribute, children }));
...
function ConnectModal({ trigger, open, defaultOpen, onOpenChange }) {
  ...
  return (0, import_jsx_runtime15.jsxs)(Root, { open: open ?? isModalOpen, onOpenChange: handleOpenChange, children: [
    (0, import_jsx_runtime15.jsx)(Trigger, { asChild: true, children: trigger }),
    (0, import_jsx_runtime15.jsx)(Portal, { children: (0, import_jsx_runtime15.jsx)(StyleMarker, { children: (0, import_jsx_runtime15.jsx)(Overlay, { className: overlay, children: (0, import_jsx_runtime15.jsxs)(Content, { className: content, "aria-describedby": void 0, children: [
        ...
        "div",
        {
          ...
          children: [
            (0, import_jsx_runtime15.jsxs)("div", { className: walletListContent, children: [
              (0, import_jsx_runtime15.jsx)(Title, { className: title, asChild: true, children: (0, import_jsx_runtime15.jsx)(Heading, { as: "h2", children: "Connect a Wallet" }) }),
      ...
      (0, import_jsx_runtime15.jsx)(Close, { className: closeButtonContainer, asChild: true, children: (0, import_jsx_runtime15.jsx)(IconButton, { type: "button", "aria-label": "Close", children: (0, import_jsx_runtime15.jsx)(CloseIcon, {}) }) })
    ] }) }) }) })
  ] });
}
...
function AccountDropdownMenu({ currentAccount }) {
  ...
  return (0, import_jsx_runtime19.jsxs)(Root2, { modal: false, children: [
    (0, import_jsx_runtime19.jsx)(StyleMarker, { children: (0, import_jsx_runtime19.jsx)(Trigger2, { asChild: true, children: (0, import_jsx_runtime19.jsxs)(Button, { size: "lg", className: connectedAccount, children: [
    ...
    (0, import_jsx_runtime19.jsx)(Portal2, { children: (0, import_jsx_runtime19.jsx)(StyleMarker, { className: menuContainer, children: (0, import_jsx_runtime19.jsxs)(Content2, { className: menuContent, children: [
      ...
      (0, import_jsx_runtime19.jsx)(Separator2, { className: separator }),
...
function registerUnsafeBurnerWallet(suiClient) {
  var _on2, _connect2, _signPersonalMessage2, _signTransactionBlock2, _signTransaction2, _signAndExecuteTransactionBlock, _signAndExecuteTransaction;
  const walletsApi = getWallets();
  ...
  class UnsafeBurnerWallet {
    constructor() {
      __privateAdd5(this, _on2, () => {
        return () => {
        };
      });
      __privateAdd5(this, _connect2, async () => {
        return { accounts: this.accounts };
      });
      __privateAdd5(this, _signPersonalMessage2, async (messageInput) => {
        const { bytes: bytes2, signature } = await keypair.signPersonalMessage(messageInput.message);
        return { bytes: bytes2, signature };
      });
      __privateAdd5(this, _signTransactionBlock2, async (transactionInput) => {
      ...
      __privateAdd5(this, _signTransaction2, async (transactionInput) => {
        var _a;
        const { bytes: bytes2, signature } = await Transaction.from(
          await transactionInput.transaction.toJSON()
        ).sign({
          client: suiClient,
          signer: keypair
        });
        (_a = transactionInput.signal) == null ? void 0 : _a.throwIfAborted();
        return {
          bytes: bytes2,
          signature
        };
      ...
      __privateAdd5(this, _signAndExecuteTransaction, async (transactionInput) => {
        var _a;
        const { bytes: bytes2, signature } = await Transaction.from(
          await transactionInput.transaction.toJSON()
        ).sign({
    ...
    get features() {
      return {
        "standard:connect": {
          version: "1.0.0",
          connect: __privateGet7(this, _connect2)
        },
        "standard:events": {
          version: "1.0.0",
          on: __privateGet7(this, _on2)
        },
        "sui:signPersonalMessage": {
          version: "1.0.0",
          signPersonalMessage: __privateGet7(this, _signPersonalMessage2)
        },
        "sui:signTransactionBlock": {
          version: "1.0.0",
          signTransactionBlock: __privateGet7(this, _signTransactionBlock2)
        },
        "sui:signAndExecuteTransactionBlock": {
          version: "1.0.0",
          signAndExecuteTransactionBlock: __privateGet7(this, _signAndExecuteTransactionBlock)
        },
        "sui:signTransaction": {
          version: "2.0.0",
          signTransaction: __privateGet7(this, _signTransaction2)
        },
        "sui:signAndExecuteTransaction": {
          version: "2.0.0",
          signAndExecuteTransaction: __privateGet7(this, _signAndExecuteTransaction)
        }
      };
    }
  }
...
function useSignAndExecuteTransaction({
  ...
  const executeTransaction = execute2 ?? (async ({ bytes: bytes2, signature }) => {
  ...
  return useMutation({
    ...
    mutationFn: async ({ transaction, ...signTransactionArgs }) => {
      ...
      const chain2 = signTransactionArgs.chain ?? (signerAccount == null ? void 0 : signerAccount.chains[0]);
      ...
      const { signature, bytes: bytes2 } = await signTransaction(currentWallet, {
        ...signTransactionArgs,
        transaction: {
          async toJSON() {
      ...
      const result = await executeTransaction({ bytes: bytes2, signature });
      let effects;
      if ("effects" in result && ((_a = result.effects) == null ? void 0 : _a.bcs)) {
...
function useSignTransaction({
  ...
  return useMutation({
    ...
    mutationFn: async ({ transaction, ...signTransactionArgs }) => {
      ...
      const { bytes: bytes2, signature } = await signTransaction(currentWallet, {
        ...signTransactionArgs,
        transaction: {
          toJSON: async () => {
            return typeof transaction === "string" ? transaction : await transaction.toJSON({
